...
class jobDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                    ...
                    if((i).toString().equals(jobId)){
                        ...
                        database.addListenerForSingleValueEvent(object : ValueEventListener {
                            override fun onDataChange(ds: DataSnapshot) {
                                binding.comName.text = "Company Name: " + ds.child(companyId).child("user_name").value.toString()
                                binding.location.text = ds.child(companyId).child("user_address").value.toString()
                            }
        ...
        binding.button.setOnClickListener{
            ...
            val intent = Intent(this, myApplyActivity::class.java)
